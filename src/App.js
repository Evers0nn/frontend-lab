...
import 'react-toastify/dist/ReactToastify.css'; // Estilos das notificações
import './index.css';
...
function App() {
  ...
  const handleBaixarPDF = () => {
    toast.info("Gerando relatório em PDF..."); // Aviso bonito na hora de baixar
    const doc = new jsPDF();
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      toast.error("Servidor offline ou com falha!"); 
    }
  };
